...
function validateForm() {
  ...
  <body>
    ...
    <main>
 <h1 align='center'>Manager Registration</h1><br>

<form action="./register" onsubmit="return validateForm()">
<input type="hidden" name="signupType" value="${signupType}"> <label for="name">Manger Name: </label> <input type="text"
			id="name" name="name" placeholder="Manger name" value=" ${name}" required>
